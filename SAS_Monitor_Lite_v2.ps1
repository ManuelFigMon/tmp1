...
function Export-DashboardData {
    # Reads all monthly CSVs and writes data/sas_monitor_data.json for the dashboard.
    try {
        $jsPath = "$DataDir\sas_monitor_data.json"
        ...
        [System.IO.File]::WriteAllText($jsPath, $json, [System.Text.Encoding]::UTF8)
